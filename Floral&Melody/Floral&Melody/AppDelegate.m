...
#pragma mark - tabbarController
    ...
    if ([str isEqualToString:@"有了"]==NO) {
        ...
        first.imageArray = [NSArray arrayWithObjects:[UIImage imageNamed:@"meigui.jpg"],[UIImage imageNamed:@"one"], [UIImage imageNamed:@"qidong_1"],[UIImage imageNamed:@"three"],[UIImage imageNamed:@"four"],nil];
